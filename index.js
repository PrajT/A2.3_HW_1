...
let tvBrand = "Sony"
let tvPrice = 50000
let meetsCriteria = tvScreenSize >= 50 && (tvBrand === "Sony" || tvBrand === "Samsung")

console.log("Does the TV meet the criteria? " , meetsCriteria)
console.log("---- ---- ----")

console.log("3.2")
let watchReleaseYear = 2021
let watchSize = "L"
let watchBrand = "Apple"
let isDiscountApplicable = watchReleaseYear === 2022 && (watchSize === "M" || watchSize === "L" )
